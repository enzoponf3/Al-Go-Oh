...
public class VistaZonaNoMonstruos extends HBox {
    ...
    public void dibujar() {
        ...
        for(NoMonstruo noMonstruo: jugador.getNoMonstuosEnCampo()) {
            Jugador jugadorActual = controladorDeTurnos.getJugador();
            VistaCarta vistaNoMonstruo;
            if(jugadorActual == jugador) {
                vistaNoMonstruo = new VistaCarta(cartaVistaUtils.getImagenDeCarta(noMonstruo.getNombre()), jugador, noMonstruo);
